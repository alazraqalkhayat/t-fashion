...
import 'package:t_fashion/ProductDetails/models/ProductDetailsModel.dart';
import 'package:t_fashion/ProductDetails/widgets/SizeContainer.dart';
...
import 'package:t_fashion/ProductDetails/widgets/ProductColor.dart';
    ...
    return SafeArea(
      child: Scaffold(
        body: ChangeNotifierProvider(
          create: (context) => ProductDetailsModel(),
          child:Consumer<ProductDetailsModel>(
            builder: (context, productDetailsModel, child) =>  Stack(
            children: [
              Container(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                      onPressed: () {
                        productDetailsModel.changeIconName("share.svg");
                      },
                      icon: SvgPicture.asset("${kIconsPath}${productDetailsModel.iconName}",)
                    )
                  ],
                ),
              ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        child: GestureDetector(
                                          child: SvgPicture.asset(
                                              "${kIconsPath}up.svg"),
                                          onTap: () {
                                            productDetailsModel.increesCounter();
                                          },
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        flex: 1,
                                        child: SubTitleText(
                                          subTitle: productDetailsModel.counter
                                              .toString(),
                                          color: kDarkOrange,
                                          fontSize: 15,
                                        ),
                                      ...
                                      Expanded(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          onTap: (){
                                            productDetailsModel.decreesCounter();
                                          },
                                        ),
                                      ),
                                    ],
